#ifndef _CSV_REFINEDREADER_H_
#define _CSV_REFINEDREADER_H_
...
struct CSVRefinedReader
{
	static void ReadFile(std::ifstream* fin, std::vector< InteractionData >& interactions);
};

void CSVRefinedReader::ReadFile(std::ifstream* fin, std::vector< InteractionData >& interactions)
{	
	std::string word, row;
